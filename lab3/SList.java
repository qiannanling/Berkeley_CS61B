/**
 * Berkeley CS61B 2014 Spring lab 3
 * SList.java
 * @author Qiannan Ling
 */
...
public class SList {
	...
	public static void main (String[] args) {
		// Part I:
		// 1. Construct a SList: [ 6, 9, 12 ] & print it
		// 2. Modify the SLidt above to be like [ 3, 6, 9, 12, 15 ] & print it
		SList part1 = new SList();
		part1.insertFront(6);
		part1.insertEnd(9);
		part1.insertEnd(12);
		...
		// Part II:
		// Modify the existing .insertEnd() method and other methods if necessary
		// to make the .insertEnd() method run in constant time
