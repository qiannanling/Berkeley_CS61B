///**
// * Berkeley CS61B 2014 Spring hw 3
// * SList.java 
// * @author Qiannan Ling
// */
//
...
//			SListNode curr = this.nth(length);
//			for (int i = length - 1; i > 1; i--) {
//				if (this.nth(i).item.equals(curr.item)) {
//					this.nth(i-1).next = this.nth(i+1);
//					this.size --;
//				} else {
//					curr = this.nth(i);
//				}
//			}
//			if (this.length() >= 2 && this.nth(1).item.equals(this.nth(2).item)) {
//				this.nth(1).next = this.nth(3);
//				this.size --;
//			}
//		}
//	}
...
//			SListNode newNode = new SListNode(this.nth(i).item);
//			if (i != length) {
//				newNode.next = this.nth(i+1);
//			}
//			this.nth(i).next = newNode;
//		}
//	}
//
//	/**
